...
export const calibrationQuantities: CalibrationQuantity[] = [
  {
    ...
    equipment: [
      ...
      e(
        ...
        "Quando aplicável, critérios de aceitação, documentação requerida e regras de decisão devem ser definidos para a avaliação de conformidade.",
      ),
    ],
  },
  {
    ...
    equipment: [
      ...
      e(
        ...
        ["processos químicos", "estudos de processo", "bateladas"],
